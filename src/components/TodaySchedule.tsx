...
const colorMap: Record<string, string> = {
  blue: 'bg-amber-100/50 text-amber-800 border-amber-200 dark:bg-amber-500/20 dark:text-amber-300 dark:border-amber-500/30',
  purple: 'bg-orange-100/50 text-orange-800 border-orange-200 dark:bg-orange-500/20 dark:text-orange-300 dark:border-orange-500/30',
  emerald: 'bg-stone-100/50 text-stone-800 border-stone-200 dark:bg-stone-500/20 dark:text-stone-300 dark:border-stone-500/30',
  ...
  indigo: 'bg-stone-100/50 text-stone-800 border-stone-200 dark:bg-stone-500/20 dark:text-stone-300 dark:border-stone-500/30',
  rose: 'bg-red-100/50 text-red-800 border-red-200 dark:bg-red-500/20 dark:text-red-300 dark:border-red-500/30',
};
  ...
  if (todayClasses.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-4 text-slate-400">
        ...
        <p className="text-xs font-medium">오늘의 수업 일정이 없습니다.</p>
      </div>
    );
  }
