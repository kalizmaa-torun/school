    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link 
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white rounded-xl transition-all font-bold shadow-lg shadow-[var(--primary)]/20 active:scale-95 whitespace-nowrap shrink-0"
        >
          <PenSquare size={18} />
          <span>글쓰기</span>
        </Link>
